...
Personally recommend using [TEXMAKER](https://www.xm1math.net/texmaker/) and [TeXstudio](www.texstudio.org). These two are both free cross-platform LaTeX editor.
